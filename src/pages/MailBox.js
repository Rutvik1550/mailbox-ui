            ...
            <div className="row">
                  ...
                  <div className="card-body">
                    <ul className="todo-list" data-widget="todo-list">
                      ...
                      <li>
                        ...
                        <div className="icheck-primary d-inline ml-2">
                          <input type="checkbox" value="" name="todo2" id="todoCheck2" checked onChange={() => {}} />
              ...
              <section className="col-lg-5 connectedSortable">
                ...
                <div className="card bg-gradient-info">
                  ...
                  <div className="card-body">
                    <canvas className="chart" id="line-chart" style={{ minHeight: 250, height: 250, maxHeight: 250, maxWidth: "100%"}}></canvas>
                  </div>
